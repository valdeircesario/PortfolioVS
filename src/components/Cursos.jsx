...
<div className={`${Styles.scroll} ${Styles.snap} ${Styles.card}`}>
    ...
    <div className={`${Styles.slide} ${Styles.red}`}>
        ...
        <div className={Styles.component}>
            ...
            <Addcursos 
                coverSrc="/public/cursos/Cert_Programador Web (1).jpg.jpg"
                imgSrc="/public/cursos/Cert_Programador Web (1).jpg"
            ...
            <Addcursos 
                coverSrc="/public//cursos/Cert_administrador banco de dados.jpg"
                imgSrc="/public//cursos/Cert_administrador banco de dados.jpg"
                altText="Descrição da imagem 1"
            ...
            <Addcursos 
                coverSrc="/public//cursos/Cert_Conceito Java.jpg"
                imgSrc="/public/cursos/Cert_Conceito Java.jpg"
            ...
            <Addcursos 
                coverSrc="/public/cursos/Cert_Manutenção Computadores.jpg"
                imgSrc="/public/cursos/Cert_Manutenção Computadores.jpg"
    ...
    <div className={Styles.component}>
        ...
        <Addcursos
            coverSrc="/public/cursos/Cert_Botcamp negocio do Futuro.jpg"
            imgSrc="/public/cursos/Cert_Botcamp negocio do Futuro.jpg"
            altText="BOTCAMP"
        ...
        <Addcursos
            coverSrc="/public/cursos/Cert_Equipe,Estrateja de suscesso.jpg"
            imgSrc="/public/cursos/Cert_Equipe,Estrateja de suscesso.jpg"
        ...
        <Addcursos
            coverSrc="/public/cursos/Cert_Google Drive.jpg"
            imgSrc="/public/cursos/Cert_Google Drive.jpg"
    ...
    <div  className={`${Styles.slide} ${Styles.green}`}>
        ...
        <Addcursos
            coverSrc="/public/cursos/Cert_Introdução Java.jpg"
            imgSrc="/public/cursos/Cert_Introdução Java.jpg"
        ...
        <Addcursos
            coverSrc="/public/cursos/Cert_Programador Web.jpg"
            imgSrc="/public/cursos/Cert_Programador Web.jpg"
        ...
        <Addcursos
            coverSrc="/public/cursos/Cert_Preojeto Sitema WEB.jpg"
            imgSrc="/public/cursos/Cert_Preojeto Sitema WEB.jpg"
